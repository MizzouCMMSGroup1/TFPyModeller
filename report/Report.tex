...
We selected the following targets from the CASP database to build a model for: T644 (166 residues), T645 (97 residues), and T-646 (537 residues).  This allows us a combination of small, medium, and large targets to test.
